...
@pytest.mark.parametrize(
    'input_fn', [iter([b'1234', b'45467']), iter([DocumentProto(), DocumentProto()])]
)
...
@pytest.mark.parametrize(
    'input_fn', [iter([list(), list(), [12, 2, 3]]), iter([set(), set()])]
)
...
@pytest.mark.parametrize(
    ...
    [(random_port(), '/status', 200), (random_port(), '/api/ass', 405)],
)
