    ...
    if not allow_remote:
        ...
        if args.host != __default_host__:
            ...
            default_logger.warning(
                f'setting host to {__default_host__} as allow_remote set to False'
            )
...
def Pod(
    args: Union['argparse.Namespace', Dict] = None, allow_remote: bool = True, **kwargs
):
            ...
            if k:
                ...
                for kk in k:
                    if not allow_remote and kk.host != __default_host__:
                        ...
                        default_logger.warning(
                            f'host is reset to {__default_host__} as allow_remote=False'
                        )
                    hosts.add(kk.host)
